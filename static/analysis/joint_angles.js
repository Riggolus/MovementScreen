...
export function computeJointAngles(landmarks) {
  ...
  // NOTE: Knee varus (ankle-vertical method) was removed. Natural foot external
  // rotation during a squat places the knee slightly lateral to the ankle even in
  // healthy subjects, producing systematic false-varus from 2D frontal projection.
  // Valgus detection (hip-ankle line) is retained; reliable varus requires 3D data.
